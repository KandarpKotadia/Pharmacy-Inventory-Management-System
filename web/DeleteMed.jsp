               ...
               <div class="body" style="background-color: rgba(244, 244, 244, 0.5);height: 660px">
                    <div class="row" style="margin: 0;padding: 0">
                         ...
                         <div class="col-md-10" style="padding-top: 30px">
                              <h3 style="font-size: 35px;padding-left: 20px">Delete Medicine</h3><br>
                              <form action="DeleteMed" method="post" style="padding-left: 70px">
                                   Enter Medicine name to Delete:<br>
                                   <input type="text" name="deleteMed" style="width: 1000px" required><br><br>
                                   <input type="submit" value='Delete Medicine form Inventory'>
                              </form>
                         </div>
                    </div>
               </div>
