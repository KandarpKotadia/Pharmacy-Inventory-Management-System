          ...
          <div class="container-fluid" style="padding: 0">
               <div class="row navigation-bar" style="background-color: #ccffcc">
                    ...
                    <div class="col-md-2" style="padding: 0">
                         ...
                         <div class="body" style="background-color: rgba(244, 244, 244, 0.5)">
                    <div class="row" style="margin: 0;padding: 0">
                         ...
                         <div class="col-md-10" style="padding-top: 30px">
                              <h3 style="font-size: 35px;padding-left: 20px">ADD MEDICINE</h3><br>
                              <form action="Add" method="post" style="padding-left: 70px">
                                   Enter Medicine Name: <br>
                                   <input type="text" name="medName" required style="width: 1000px"><br><br>
                                   Enter Medicine Company: <br>
                                   <input type="text" name="medComp" style="width: 1000px" required><br><br>
                                   Enter Arrival Date: <br>
                                   <input type="date" name="arrDate" style="width: 1000px" required><br><br>
                                   Enter Expiry Date: <br>
                                   <input type="date" name="expDate" style="width: 1000px" required><br><br>
                                   
                                   Enter Type of Medicine: <br>
                                   <select name="type" style="width: 1000px" required>
                                   ...
                                   Enter Quantity: <br>
                                   <input type="number" name="quantity" style="width: 1000px" required><br><br>
                                   Enter Price: <br>
                                   <input type="number" name="price"style="width: 1000px" required><br><br>
                                   <input type="submit" value="Add Medicine to Inventory">
                                   <br><br><br>
                              </form>
                         </div>
                    </div>
